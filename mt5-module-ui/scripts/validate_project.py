...
for feature in ("handlePanned", "handlePinched", "Choose from Photos", "linkTapped", "addCustomElement", "scaleSliderChanged", "canvasPanned", "maximumValue = 50.0", "imageRectForContentRect"):
